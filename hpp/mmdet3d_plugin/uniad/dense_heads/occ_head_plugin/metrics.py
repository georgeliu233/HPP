...
class IntersectionOverUnion(Metric):
    ...
    def update(self, prediction: torch.Tensor, target: torch.Tensor):
        tps, fps, _, fns, sups = stat_scores(prediction, target, num_classes=self.n_classes,mdmc_reduce="global") #,task="multiclass")
    ...
    def compute(self):
        ...
        return torch.mean(scores)#, reduction=self.reduction)

_base_ = ["../_base_/datasets/nus-3d_ailab.py",
...
model = dict(
    ...
    motion_head=dict(
        ...
        anchor_info_path='/cpfs01/user/liuhaochen/nuscenes/motion_anchor_infos_mode6.pkl',
        transformerlayers=dict(
            type='CustomMotionTransformerDecoder',
            pc_range=point_cloud_range,
            embed_dims=_dim_,
            num_layers=3,
            transformerlayers=dict(
    ...
    planning_head=dict(
        ...
        # loss_occol=[
        #     # dict(type='OccCollisionLoss', delta=0.0, weight=1.0),
        #     dict(type='OccCollisionLoss', delta=0.0, weight=5.0),
        #     # dict(type='OccCollisionLoss', delta=1.0, weight=200.0),
        #     # dict(type='OccCollisionLoss', delta=2.0, weight=50.0)
        #     ],
        # loss_predcol=dict(type='PlanPredCollisionLoss', loss_weight=1.0),
...
info_root = "/cpfs01/shared/opendrivelab/opendrivelab_hdd/UniAD_Proj/infos/"
...
load_from = "/cpfs01/user/liuhaochen/nuscenes/UniAD-s1-ViDAR-RN101-nus-full-1future.pth"
